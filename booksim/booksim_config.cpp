...
{ 
  ...
  _int_map["speculative_va"]    = 0;  // speculate on vc allocation
  _int_map["speculative_sw"]    = 0;  // speculate on sw allocation
  _int_map["speculative_st"]    = 0;  // speculate on switch traversal

  //==== Flit-reservation ==================================

  _int_map["reservation_size"]  = 16; 
  _int_map["input_buffer_pool"] = 8;  
  ...
  //   bit_complement
  //   shuffle
  //   hot_spot       - a destination node is x times more likely
  //   random_perms   - x random permutations
  //   perm           - a user-specified permutation
  //
