...
void VC::Route( tRoutingFunction rf, const VCRouter* router, const Flit* f, int in_channel )
{  
  rf( (const Router *)router, f, in_channel, _route_set, false );
}
...
void VC::Display( ) const
{
  ...
  //cout << "  times used : " << _occupied_cnt << endl;
}
